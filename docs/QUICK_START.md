...
In `heatvalve-6.yaml`, uncomment the appropriate board:
...
5. Select "Pipe Type" (typically PEX 16x2 or AluPEX 16x2)
6. Select "Floor Type" and set "Floor Cover Thickness" (typically 15mm)

The system will automatically calculate pipe lengths and apply floor/pipe correction factors for better estimation.
...
2. Uncomment MQTT in `heatvalve-6.yaml`:

...
`,ur=h({tag:"hv6-header",render:Ft,onMount(e,t){let r=t.querySelector("#hdr-mode"),o=t.querySelector("#hdr-dot"),n=t.querySelector("#hdr-sync"),a=t.querySelector("#hdr-up"),l=t.querySelector("#hdr-wifi"),d=t.querySelector("#hdr-fw"),g=t.querySelectorAll(".menu-link");function m(){let f=k("section");g.forEach(S=>{S.classList.toggle("active",S.getAttribute("data-section")===f)})}function u(){let f=k("live"),S=k("pendingWrites"),x=window.HV6_DASHBOARD_CONFIG&&window.HV6_DASHBOARD_CONFIG.mock?window.HV6_DASHBOARD_CONFIG.mockLabel||"Mock":f?"Live":"Offline";r.textContent=x,o.classList.toggle("on",!!f),n.textContent=S>0?"Saving...":f?"Synced":"Offline";let z=S>0?"saving":f?"synced":"offline";n.className="meta-chip meta-chip-state "+z,a.textContent=ue(b(i.uptime)),l.textContent=je(b(i.wifi));let E=k("firmwareVersion")||_(i.firmware);d.textContent=E?"FW "+E:""}g.forEach(f=>{f.addEventListener("click",S=>{S.preventDefault(),Ae(f.getAttribute("data-section"))})}),F("section",m),F("live",u),F("pendingWrites",u),F("firmwareVersion",u),p(i.uptime,u),p(i.wifi,u),p(i.firmware,u),m(),u()}});var Ct="/dashboard";function Mt(){return!!(window.HV6_DASHBOARD_CONFIG&&window.HV6_DASHBOARD_CONFIG.mock)}function N(e){if(Te(),Mt())try{return ce(e),Promise.resolve({ok:!0})}finally{he()}return fetch(Ct+"/set",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:(()=>{let t=new URLSearchParams;for(let[r,o]of Object.entries(e))o!=null&&t.append(r,o);return t.toString()})()}).finally(()=>{he()})}function ze(e,t){return c(s.setpoint(e),{value:t}),N({key:"zone_setpoint",value:t,zone:e})}function Ve(e,t){return c(s.enabled(e),{state:t?"on":"off",value:t}),N({key:"zone_enabled",value:t?1:0,zone:e})}function Ge(e){return c(i.drivers,{state:e?"on":"off",value:e}),N({key:"drivers_enabled",value:e?1:0})}function ee(e,t){return N({key:"command",value:e,zone:t||void 0})}function $e(){return G("Scanning I2C bus..."),y("I2C scan started"),ee("i2c_scan")}var Lt={zone_probe:e=>s.probe(e),zone_temp_source:e=>s.tempSource(e),zone_sync_to:e=>s.syncTo(e),zone_pipe_type:e=>s.pipeType(e)},Nt={zone_zigbee_device:e=>s.zigbee(e),zone_ble_mac:e=>s.ble(e),zone_exterior_walls:e=>s.exteriorWalls(e)},Dt={zone_area_m2:e=>s.area(e),zone_pipe_spacing_mm:e=>s.spacing(e)},At={manifold_type:i.manifoldType,manifold_flow_probe:i.manifoldFlowProbe,manifold_return_probe:i.manifoldReturnProbe,motor_profile_default:i.motorProfileDefault,simple_preheat_enabled:i.simplePreheatEnabled},Ot={close_threshold_multiplier:i.closeThresholdMultiplier,close_slope_threshold:i.closeSlopeThreshold,close_slope_current_factor:i.closeSlopeCurrentFactor,open_threshold_multiplier:i.openThresholdMultiplier,open_slope_threshold:i.openSlopeThreshold,open_slope_current_factor:i.openSlopeCurrentFactor,open_ripple_limit_factor:i.openRippleLimitFactor,generic_runtime_limit_seconds:i.genericRuntimeLimitSeconds,hmip_runtime_limit_seconds:i.hmipRuntimeLimitSeconds,relearn_after_movements:i.relearnAfterMovements,relearn_after_hours:i.relearnAfterHours,learned_factor_min_samples:i.learnedFactorMinSamples,learned_factor_max_deviation_pct:i.learnedFactorMaxDeviationPct};function U(e,t,r){let o=Lt[t];return o&&c(o(e),{state:r}),N({key:t,value:r,zone:e})}function te(e,t,r){let o=Nt[t];return o&&c(o(e),{state:r}),N({key:t,value:r,zone:e})}function _e(e,t,r){let o=Number(r),n=Dt[t];return n&&!Number.isNaN(o)&&c(n(e),{value:o}),N({key:t,value:o,zone:e})}function I(e,t){let r=At[e];return r&&c(r,{state:t}),N({key:e,value:t})}function oe(e,t){let r=Number(t),o=Ot[e];return o&&!Number.isNaN(r)&&c(o,{value:r}),N({key:e,value:r})}function Ue(e,t){let r=Number(t),o=Number.isNaN(r)?0:Math.max(0,Math.min(100,Math.round(r)));return c(s.motorTarget(e),{value:o}),y("Motor "+e+" target set to "+o+"%",e),N({key:"motor_target",value:o,zone:e})}function Xe(e,t=1e4){return y("Motor "+e+" open for "+t+"ms",e),N({key:"command",value:"open_motor_timed",zone:e})}function Ye(e,t=1e4){return y("Motor "+e+" close for "+t+"ms",e),N({key:"command",value:"close_motor_timed",zone:e})}function Se(e){return y("Motor "+e+" stopped",e),N({key:"command",value:"stop_motor",zone:e})}function ke(e){return W("manualMode",!!e),y(e?"Manual mode enabled \u2014 automatic management paused":"Manual mode disabled \u2014 automatic management resumed"),N({key:"manual_mode",value:e?1:0})}function Je(e){return y("Motor "+e+" fault reset",e),N({key:"command",value:"motor_reset_fault",zone:e})}function Ke(e){return y("Motor "+e+" learned factors reset",e),N({key:"command",value:"motor_reset_learned_factors",zone:e})}function Qe(e){return y("Motor "+e+" reset and relearn started",e),N({key:"command",value:"motor_reset_and_relearn",zone:e})}var Tt=`
.status-card {
...
`,_r=h({tag:"status-card",state:()=>({motorDrivers:"---",motorDriversOn:!1,motorFault:"---",connOn:!1}),render:Rt,methods:{update(e){this.motorDriversOn=T(i.drivers),this.motorDrivers=this.motorDriversOn?"ON":"OFF",this.motorFault=T(i.fault)?"FAULT":"OK",this.connOn=k("live")===!0,e.drv.textContent=this.motorDrivers,e.drv.style.color=this.motorDriversOn?"var(--blue)":"var(--state-danger)";let t=this.motorFault==="FAULT";e.fault.textContent=this.motorFault,e.fault.style.color=t?"var(--state-danger)":"var(--state-ok)",e.dot.classList.toggle("on",this.connOn),e.sw.className="sw "+(this.motorDriversOn?"on":"off")}},onMount(e,t){let r={drv:t.querySelector("#sys-drv"),fault:t.querySelector("#sys-fault"),dot:t.querySelector("#sys-dot"),sw:t.querySelector("#sw-drv")},o=()=>e.update(r);p(i.drivers,o),p(i.fault,o),F("live",o),r.sw.onclick=()=>{Ge(!e.motorDriversOn)},o()}});var qt=`
.connectivity-card {
  background: var(--panel-bg);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`,Lr=h({tag:"connectivity-card",render:Pt,onMount(e,t){let r=t.querySelector(".cc-ip"),o=t.querySelector(".cc-ssid"),n=t.querySelector(".cc-mac"),a=t.querySelector(".cc-up");function l(){r.textContent=_(i.ip)||"---",o.textContent=_(i.ssid)||"---",n.textContent=_(i.mac)||"---",a.textContent=ue(b(i.uptime))}p(i.ip,l),p(i.ssid,l),p(i.mac,l),p(i.uptime,l),l()}});var Zt=`
.graph-widgets {
  display: grid;
  gap: 12px;
}
...
`;function et(e,t,r,o){if(!e.length)return"";let n=Math.min.apply(null,e),a=Math.max.apply(null,e),l=Math.max(.001,a-n),d=e.length>1?(t-o*2)/(e.length-1):0,g="";for(let m=0;m<e.length;m++){let u=o+d*m,f=r-o-(e[m]-n)/l*(r-o*2);g+=(m?" L ":"M ")+u.toFixed(2)+" "+f.toFixed(2)}return g}function tt(e,t,r,o,n){e.innerHTML="";let a=et(t,220,56,5);if(a){let d=document.createElementNS("http://www.w3.org/2000/svg","path");d.setAttribute("d",a),d.setAttribute("fill","none"),d.setAttribute("stroke",r),d.setAttribute("stroke-width","2.2"),d.setAttribute("stroke-linecap","round"),e.appendChild(d)}let l=o&&o.length?et(o,220,56,5):"";if(l){let d=document.createElementNS("http://www.w3.org/2000/svg","path");d.setAttribute("d",l),d.setAttribute("fill","none"),d.setAttribute("stroke",n),d.setAttribute("stroke-width","2"),d.setAttribute("stroke-linecap","round"),e.appendChild(d)}}var Ht="var(--accent)",Bt="var(--blue)",Wt="var(--blue)",Tr=h({tag:"graph-widgets",render:It,onMount(e,t){let r=t.querySelector(".gw-dt"),o=t.querySelector(".gw-demand-text"),n=t.querySelector(".gw-flow"),a=t.querySelector(".gw-demand");function l(){let d=k("historyFlow"),g=k("historyReturn"),m=k("historyDemand"),u=d.length?d[d.length-1]:null,f=g.length?g[g.length-1]:null,S=m.length?m[m.length-1]:null;r.textContent=u!=null&&f!=null?(u-f).toFixed(1)+" C":"---",o.textContent=S!=null?Math.round(S)+"%":"---",tt(n,d,Ht,g,Bt),tt(a,m,Wt)}F("historyFlow",l),F("historyReturn",l),F("historyDemand",l),l()}});var jt=`
.zone-grid {
    display: grid;
...
`;w("zone-grid",jt);var Vt=()=>'<div class="zone-grid"></div>',Zr=h({tag:"zone-grid",render:Vt,onMount(e,t){for(let r=1;r<=6;r++)t.appendChild(M("zone-card",{zone:r}))}});var Gt=`
.zone-card {
	display: grid;
...
`,ea=h({tag:"zone-detail",state:e=>({zone:e.zone,temp:"---",setpoint:"---",valve:"---",state:"---"}),render:Xt,methods:{update(e,t){let r=k("selectedZone"),o=String(_(s.state(r))||"").toUpperCase(),n=T(s.enabled(r));this.zone=r,e.dataset.zone=String(r),t.title.textContent=V(r),t.setpoint.textContent=D(b(s.setpoint(r))),t.temp.textContent=D(b(s.temp(r))),t.ret.textContent=D(b("sensor-manifold_return_temperature")),t.valve.textContent=$(b(s.valve(r)));let a=t.badge;a.textContent=n?o||"IDLE":"DISABLED";let l=n?o==="HEATING"?"badge-heating":o==="IDLE"?"badge-idle":o==="FAULT"?"badge-fault":"":"badge-disabled";a.className="zd-badge"+(l?" "+l:""),t.toggle.classList.toggle("on",n)},incSetpoint(){let e=this.zone,t=b(s.setpoint(e))||20;ze(e,Number((t+.5).toFixed(1)))},decSetpoint(){let e=this.zone,t=b(s.setpoint(e))||20;ze(e,Number((t-.5).toFixed(1)))},toggleEnabled(){let e=this.zone,t=T(s.enabled(e));Ve(e,!t)}},onMount(e,t){let r={title:t.querySelector(".zd-title"),setpoint:t.querySelector(".zd-setpoint"),temp:t.querySelector(".zd-temp"),ret:t.querySelector(".zd-ret"),valve:t.querySelector(".zd-valve"),badge:t.querySelector(".zd-badge"),toggle:t.querySelector(".btn-toggle"),inc:t.querySelector(".btn-inc"),dec:t.querySelector(".btn-dec")};r.inc.onclick=()=>e.incSetpoint(),r.dec.onclick=()=>e.decSetpoint(),r.toggle.onclick=()=>e.toggleEnabled();let o=()=>e.update(t,r),n=a=>{let l=k("selectedZone");(a===s.temp(l)||a===s.setpoint(l)||a===s.valve(l)||a===s.state(l)||a===s.enabled(l))&&o()};for(let a=1;a<=6;a++)p(s.temp(a),n),p(s.setpoint(a),n),p(s.valve(a),n),p(s.state(a),n),p(s.enabled(a),n);p("sensor-manifold_return_temperature",o),F("selectedZone",o),o()}});var Yt=`
.zone-sensor-card {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`;w("zone-sensor-card",Yt);var Jt=()=>{let e="<option>None</option>";for(let t=1;t<=8;t++)e+="<option>Probe "+t+"</option>";return`
  ...
  `};function Kt(e,t){let r=e.value,o="<option>None</option>";for(let n=1;n<=6;n++)n!==t&&(o+="<option>Zone "+n+"</option>");e.innerHTML=o,e.value=r||"None"}var ia=h({tag:"zone-sensor-card",render:Jt,onMount(e,t){let r=t.querySelector(".zs-probe"),o=t.querySelector(".zs-source"),n=t.querySelector(".zs-zigbee"),a=t.querySelector(".zs-ble"),l=t.querySelector(".zs-sync"),d=t.querySelector(".zs-row-zigbee"),g=t.querySelector(".zs-row-ble"),m=0;function u(){return k("selectedZone")}function f(){let x=u();m!==x&&(Kt(l,x),m=x);let z=_(s.probe(x)),E=_(s.tempSource(x))||"Local Probe",R=_(s.syncTo(x))||"None",J=_(s.zigbee(x))||"",ne=_(s.ble(x))||"";z&&(r.value=z),o.value=E,l.value=R,document.activeElement!==n&&(n.value=J),document.activeElement!==a&&(a.value=ne),d.style.display=E==="Zigbee MQTT"?"":"none",g.style.display=E==="BLE Sensor"?"":"none"}function S(x){let z=u();(x===s.probe(z)||x===s.tempSource(z)||x===s.syncTo(z)||x===s.zigbee(z)||x===s.ble(z))&&f()}r.addEventListener("change",()=>{U(u(),"zone_probe",r.value)}),o.addEventListener("change",()=>{U(u(),"zone_temp_source",o.value)}),l.addEventListener("change",()=>{U(u(),"zone_sync_to",l.value)}),n.addEventListener("change",()=>{te(u(),"zone_zigbee_device",n.value)}),a.addEventListener("change",()=>{te(u(),"zone_ble_mac",a.value)}),F("selectedZone",f);for(let x=1;x<=6;x++)p(s.probe(x),S),p(s.tempSource(x),S),p(s.syncTo(x),S),p(s.zigbee(x),S),p(s.ble(x),S);f()}});var Qt=`
.zone-room-card {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`,ga=h({tag:"zone-room-card",render:eo,onMount(e,t){let r=t.querySelector(".zr-friendly"),o=t.querySelector(".zr-area"),n=t.querySelector(".zr-spacing"),a=t.querySelector(".zr-pipe"),l=t.querySelectorAll(".wall-btn");function d(){return k("selectedZone")}function g(){let u=d();document.activeElement!==r&&(r.value=Z(u)||""),document.activeElement!==o&&(o.value=b(s.area(u))!=null?String(b(s.area(u))):""),document.activeElement!==n&&(n.value=b(s.spacing(u))!=null?String(b(s.spacing(u))):""),a.value=_(s.pipeType(u))||"Unknown";let f=_(s.exteriorWalls(u))||"None",S=f==="None"?[]:f.split(",").filter(Boolean);l.forEach(x=>{let z=x.dataset.wall;x.classList.toggle("active",z==="None"?S.length===0:S.includes(z))})}function m(u){let f=d();(u===s.area(f)||u===s.spacing(f)||u===s.pipeType(f)||u===s.exteriorWalls(f))&&g()}r.addEventListener("change",()=>{qe(d(),r.value)}),o.addEventListener("change",()=>{_e(d(),"zone_area_m2",o.value)}),n.addEventListener("change",()=>{_e(d(),"zone_pipe_spacing_mm",n.value||"200")}),a.addEventListener("change",()=>{U(d(),"zone_pipe_type",a.value)}),l.forEach(u=>{u.addEventListener("click",()=>{let f=u.dataset.wall,S=_(s.exteriorWalls(d()))||"None",x=S==="None"?[]:S.split(",").filter(Boolean);if(f==="None")x=[];else{let E=x.indexOf(f);E>=0?x.splice(E,1):x.push(f)}let z=["N","S","E","W"].filter(E=>x.includes(E));te(d(),"zone_exterior_walls",z.length?z.join(","):"None")})}),F("selectedZone",g),F("zoneNames",g);for(let u=1;u<=6;u++)p(s.area(u),m),p(s.spacing(u),m),p(s.pipeType(u),m),p(s.exteriorWalls(u),m);g()}});var to=`
.flow-wrap {
  width: 100%;
  border-radius: 18px;
  overflow: hidden;
...
`;w("flow-diagram",to);var q=6,nt=[60,126,192,258,324,390],fe=225,X=36,ae=160,me=90,re=X+ae,P=640,oo=11,Fe=6,Ce=24,Ee=P+20,ot=P+210,rt=P+328,at=P+420,st="#7D8BA7",it="#6C7892",ro="#8FCBFF",ao="#BCDFFF",no="#E4D092",so="#F2B74C",io="#8FCBFF",lo="#D8E7FF",co="#7D8BA7",po="#B7CBF0",uo="#6C7892",ge="#A3B6D9",mo="#8EA4CD",go="#42A5F5",fo="#66BB6A",bo="#EF5350";function be(e,t,r){var o=fe+(e-2.5)*oo,n=nt[e],a=P-re,l=re+a*.33,d=re+a*.67;return"M"+re+" "+(o-t).toFixed(1)+" C"+l+" "+(o-t).toFixed(1)+" "+d+" "+(n-r).toFixed(1)+" "+P+" "+(n-r).toFixed(1)+" L"+P+" "+(n+r).toFixed(1)+" C"+d+" "+(n+r).toFixed(1)+" "+l+" "+(o+t).toFixed(1)+" "+re+" "+(o+t).toFixed(1)+"Z"}function vo(e){if(!e)return null;let t=String(e).match(/(\d+)/);if(!t)return null;let r=Number(t[1]);return Number.isFinite(r)&&r>=1&&r<=8?r:null}function xo(e){let t=String(Z(e)||"").trim();if(!t)return"";let r=t.toUpperCase();return r.length>18?r.slice(0,17)+"\u2026":r}function ho(e,t){return t?e==null||Number.isNaN(e)?it:e<.15?ro:e<.4?ao:e<.7?no:so:st}function yo(){var e=1160,t=460,r=fe-me/2,o=[];o.push('<svg viewBox="0 0 '+e+" "+t+'" preserveAspectRatio="xMidYMid meet">'),o.push("<defs>"),o.push('<pattern id="fdots" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><circle cx="10" cy="10" r="1" fill="rgba(92,138,196,0.26)"/></pattern>'),o.push('<radialGradient id="fglow" cx="22%" cy="34%" r="72%"><stop offset="0%" stop-color="rgba(83,168,255,0.2)"/><stop offset="48%" stop-color="rgba(238,161,17,0.1)"/><stop offset="100%" stop-color="transparent"/></radialGradient>'),o.push('<linearGradient id="lbgrad" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#A06808"/><stop offset="100%" stop-color="#EEA111"/></linearGradient>');for(var n=1;n<=q;n++)o.push('<linearGradient id="rg'+n+'" x1="0" y1="0" x2="1" y2="0">'),o.push('<stop id="rgs'+n+'" offset="0%" stop-color="#EEA111"/>'),o.push('<stop id="rga'+n+'" offset="100%" stop-color="#53A8FF"/>'),o.push("</linearGradient>");o.push("</defs>"),o.push('<rect width="'+e+'" height="'+t+'" rx="22" fill="#0F213C"/>'),o.push('<rect width="'+e+'" height="'+t+'" rx="22" fill="url(#fdots)" opacity="0.5"/>'),o.push('<rect width="'+e+'" height="'+t+'" rx="22" fill="url(#fglow)"/>');for(var a=1;a<=q;a++){var l=be(a-1,Fe,Ce);o.push('<path d="'+l+'" fill="#1E2233" opacity="0.9"/>')}for(a=1;a<=q;a++){var d=be(a-1,Fe,Ce);o.push('<path id="fd-path-'+a+'" d="'+d+'" fill="url(#rg'+a+')" opacity="1" style="transition:d .6s ease,opacity .4s ease"/>')}o.push('<line x1="'+P+'" y1="36" x2="'+P+'" y2="'+(t-36)+'" stroke="#EEA111" stroke-width="3" opacity="0.55"/>');var g=5,m=X-g;for(o.push('<rect x="0" y="'+r+'" width="'+m+'" height="'+me+'" fill="url(#lbgrad)" rx="4"/>'),o.push('<rect x="'+X+'" y="'+r+'" width="'+ae+'" height="'+me+'" rx="6" fill="#EEA111"/>'),o.push('<text x="'+(X+ae/2)+'" y="'+(fe-10)+'" text-anchor="middle" font-size="20" font-weight="800" fill="#141A27" letter-spacing="2">FLOW</text>'),o.push('<text id="fd-flow-temp" x="'+(X+ae/2)+'" y="'+(fe+22)+'" text-anchor="middle" font-size="26" font-weight="800" fill="#141A27" font-family="var(--mono)">---</text>'),o.push('<text id="fd-ret-temp" x="'+(X+ae/2)+'" y="'+(r+me+28)+'" text-anchor="middle" font-size="17" font-weight="700" fill="#53A8FF" font-family="var(--mono)">RET ---</text>'),o.push('<text x="'+Ee+'" y="34" font-size="11" fill="'+ge+'" font-weight="700" letter-spacing="2">ZONE</text>'),o.push('<text x="'+ot+'" y="34" font-size="11" fill="'+ge+'" font-weight="700" letter-spacing="2">TEMP</text>'),o.push('<text x="'+rt+'" y="34" font-size="11" fill="'+ge+'" font-weight="700" letter-spacing="2">FLOW</text>'),o.push('<text x="'+at+'" y="34" font-size="11" fill="'+ge+'" font-weight="700" letter-spacing="2">RET</text>'),a=1;a<=q;a++){var u=nt[a-1];o.push('<text id="fd-zn'+a+'" x="'+Ee+'" y="'+(u+2)+'" font-size="14" fill="#CFE0FF" font-weight="700" letter-spacing="2">ZONE '+a+"</text>"),o.push('<text id="fd-zf'+a+'" x="'+Ee+'" y="'+(u+18)+'" font-size="11" fill="#A8BCE3" font-weight="700" letter-spacing="1">---</text>'),o.push('<text id="fd-zt'+a+'" x="'+ot+'" y="'+(u+10)+'" font-size="19" fill="#ECECEC" font-weight="700" font-family="var(--mono)">---\xB0C</text>'),o.push('<text id="fd-zv'+a+'" x="'+rt+'" y="'+(u+10)+'" font-size="16" fill="#AEC0E6" font-weight="700" font-family="var(--mono)">---%</text>'),o.push('<text id="fd-zr'+a+'" x="'+at+'" y="'+(u+10)+'" font-size="16" fill="#AEC0E6" font-weight="700" font-family="var(--mono)">---</text>')}return o.push('<text x="36" y="'+(t-52)+'" font-size="16" font-weight="700" fill="'+mo+'" letter-spacing="3">\u0394T Flow-Return</text>'),o.push('<text id="fd-dt" x="36" y="'+(t-16)+'" font-size="36" font-weight="800" fill="#EEA111" font-family="var(--mono)">---</text>'),o.push('<text x="'+(e-36)+'" y="'+(t-14)+'" text-anchor="end" font-size="15" fill="#2B3243" font-weight="700" letter-spacing="6">UFH - '+q+" ZONES - HEATVALVE</text>"),o.push("</svg>"),'<div class="flow-wrap">'+o.join("")+"</div>"}var wo=()=>`<div class="flow-wrap">${yo()}</div>`;h({tag:"flow-diagram",render:wo,onMount(e,t){let r={flowEl:t.querySelector("#fd-flow-temp"),retEl:t.querySelector("#fd-ret-temp"),dtEl:t.querySelector("#fd-dt"),zones:new Array(q+1)};for(let n=1;n<=q;n++)r.zones[n]={textTemp:t.querySelector("#fd-zt"+n),textFlow:t.querySelector("#fd-zv"+n),textRet:t.querySelector("#fd-zr"+n),label:t.querySelector("#fd-zn"+n),friendly:t.querySelector("#fd-zf"+n),path:t.querySelector("#fd-path-"+n)};function o(){let n=b(i.flow),a=b(i.ret),l=r.flowEl,d=r.retEl,g=r.dtEl;if(l.textContent=D(n),d.textContent="RET "+D(a),n!=null&&a!=null){let m=Number(n)-Number(a);g.textContent=m.toFixed(1)+"\xB0C",g.setAttribute("fill",m<3?go:m>8?bo:fo)}else g.textContent="---";for(let m=1;m<=q;m++){let u=b(s.temp(m)),f=b(s.valve(m)),S=T(s.enabled(m)),x=String(_(s.tempSource(m))||"Local Probe"),z=vo(_(s.probe(m))||""),E=z?b(s.probeTemp(z)):null,R=r.zones[m],J=R.textTemp,ne=R.textFlow,se=R.textRet,Me=R.label,Le=R.friendly,B=R.path,ve=f!=null?Math.max(0,Math.min(100,Number(f)))/100:0;Me.textContent="ZONE "+m;let pt=xo(m);if(Le.textContent=pt||"---",Me.setAttribute("fill",S?lo:co),Le.setAttribute("fill",S?po:uo),J.textContent=D(u),ne.textContent=$(f),ne.setAttribute("fill",ho(ve,S)),x!=="Local Probe"&&E!=null&&!Number.isNaN(Number(E))?(se.textContent=D(E),se.setAttribute("fill",S?io:st)):(se.textContent="---",se.setAttribute("fill",it)),!S)B.setAttribute("d",be(m-1,1,2)),B.setAttribute("fill","#2A2D38"),B.setAttribute("opacity","0.4");else{let ut=Math.max(3,ve*Ce),mt=Math.max(1.5,ve*Fe);B.setAttribute("d",be(m-1,mt,ut)),B.setAttribute("fill","url(#rg"+m+")"),B.setAttribute("opacity","1")}}}p(i.flow,o),p(i.ret,o),F("zoneNames",o);for(let n=1;n<=q;n++)p(s.temp(n),o),p(s.valve(n),o),p(s.enabled(n),o),p(s.probe(n),o),p(s.tempSource(n),o);for(let n=1;n<=8;n++)p(s.probeTemp(n),o);o()}});var zo=`
.diag-i2c {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`,ka=h({tag:"diag-i2c",render:_o,onMount(e,t){let r=t.querySelector("#i2c-result");function o(){r.textContent=k("i2cResult")||"No scan has been run yet."}t.querySelector("#btn-i2c-scan").addEventListener("click",()=>{$e()}),F("i2cResult",o),o()}});var So=`
.diag-zone {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`;w("diag-zone",So);function ko(e){return e==="HEATING"?"s-heating":e==="IDLE"?"s-idle":e==="FAULT"?"s-fault":""}function lt(e){return e!=null?Number(e).toFixed(2)+"x":"---"}function dt(e){return e!=null?Number(e).toFixed(0):"---"}function Eo(e){return e!=null?Number(e).toFixed(2)+"C":"---"}var Fo=()=>{let e="";for(let t=1;t<=6;t++)e+=`
...
`;w("diag-activity",Co);var Mo=()=>`
  <div class="diag-activity">
    <div class="card-title">General Activity / Log</div>
    <div class="diag-log"></div>
  </div>
`;function Lo(e,t){if(!t||!t.length){e.innerHTML='<div class="diag-log-empty">No activity yet.</div>';return}let r="";for(let o=t.length-1;o>=0;o--)r+='<div class="diag-log-item"><span class="diag-log-time">'+t[o].time+'</span><span class="diag-log-msg">'+t[o].msg+"</span></div>";e.innerHTML=r}var qa=h({tag:"diag-activity",render:Mo,onMount(e,t){let r=t.querySelector(".diag-log");function o(){Lo(r,Pe())}F("activityLog",o),o()}});var No=`
.diag-manual-badge {
  display: none;
  align-items: center;
  gap: 10px;
...
`,Ba=h({tag:"diag-manual-badge",render:Do,onMount(e,t){let r=t.classList.contains("diag-manual-badge")?t:t.querySelector(".diag-manual-badge");function o(){let n=!!k("manualMode");r&&r.classList.toggle("on",n)}F("manualMode",o),o()}});var Ao=`
.diag-zone-motor {
  background: var(--panel-bg-vibrant);
  border: 1px solid var(--panel-border);
  border-radius: 18px;
...
`;w("diag-zone-motor",Ao);var Oo=e=>{let t=e.zone||k("selectedZone")||1,r="";for(let o=1;o<=6;o++)r+='<option value="'+o+'"'+(o===t?" selected":"")+">Zone "+o+"</option>";return`
...
`;w("diag-zone-recovery",To);var Ro=e=>{let t=e.zone||k("selectedZone")||1,r="";for(let o=1;o<=6;o++)r+='<option value="'+o+'"'+(o===t?" selected":"")+">Zone "+o+"</option>";return`
  ...
  `},tn=h({tag:"diag-zone-recovery-card",render:Ro,onMount(e,t){let r=Number(e.zone||k("selectedZone")||1),o=t.querySelector(".recovery-zone-select"),n=t.querySelector(".recovery-fault-btn"),a=t.querySelector(".recovery-factors-btn"),l=t.querySelector(".recovery-relearn-btn");o==null||o.addEventListener("change",()=>{r=Number(o.value||1)}),n==null||n.addEventListener("click",()=>{Je(r)}),a==null||a.addEventListener("click",()=>{confirm("Reset learned factors for Zone "+r+"?")&&Ke(r)}),l==null||l.addEventListener("click",()=>{confirm("Reset + relearn motor for Zone "+r+"?")&&Qe(r)})}});var qo=`
...
`;w("settings-manifold-card",qo);var Po=()=>{let e="";for(let r=1;r<=8;r++)e+="<option>Probe "+r+"</option>";let t="";for(let r=1;r<=8;r++)t+='<div class="probe-cell"><div class="probe-name">Probe '+r+'</div><div class="probe-temp" data-probe="'+r+'">---</div></div>';return`
  ...
  `},cn=h({tag:"settings-manifold-card",render:Po,onMount(e,t){let r=t.querySelector(".sm-type"),o=t.querySelector(".sm-flow"),n=t.querySelector(".sm-ret");function a(){r.value=_(i.manifoldType)||"NC (Normally Closed)",o.value=_(i.manifoldFlowProbe)||"Probe 7",n.value=_(i.manifoldReturnProbe)||"Probe 8";for(let l=1;l<=8;l++){let d=t.querySelector('[data-probe="'+l+'"]'),g=b(s.probeTemp(l));d&&(d.textContent=D(g))}}r.addEventListener("change",()=>I("manifold_type",r.value)),o.addEventListener("change",()=>I("manifold_flow_probe",o.value)),n.addEventListener("change",()=>I("manifold_return_probe",n.value)),p(i.manifoldType,a),p(i.manifoldFlowProbe,a),p(i.manifoldReturnProbe,a);for(let l=1;l<=8;l++)p(s.probeTemp(l),a);a()}});var Zo=`
...
`;w("settings-control-card",Zo);var Io=()=>`
...
`;w("settings-motor-calibration-card",Ho);var Y=[{cls:"safe-runtime",key:"generic_runtime_limit_seconds",id:i.genericRuntimeLimitSeconds,label:"Max Safe Runtime",unit:"s"},{cls:"close-threshold",key:"close_threshold_multiplier",id:i.closeThresholdMultiplier,label:"Close Endstop Threshold",unit:"x"},{cls:"close-slope-threshold",key:"close_slope_threshold",id:i.closeSlopeThreshold,label:"Close Endstop Slope",unit:"mA/s"},{cls:"close-slope-floor",key:"close_slope_current_factor",id:i.closeSlopeCurrentFactor,label:"Close Endstop Slope Floor",unit:"x"},{cls:"open-threshold",key:"open_threshold_multiplier",id:i.openThresholdMultiplier,label:"Open Endstop Threshold",unit:"x"},{cls:"open-slope-threshold",key:"open_slope_threshold",id:i.openSlopeThreshold,label:"Open Endstop Slope",unit:"mA/s"},{cls:"open-slope-floor",key:"open_slope_current_factor",id:i.openSlopeCurrentFactor,label:"Open Endstop Slope Floor",unit:"x"},{cls:"open-ripple-limit",key:"open_ripple_limit_factor",id:i.openRippleLimitFactor,label:"Open Ripple Limit",unit:"x"},{cls:"relearn-movements",key:"relearn_after_movements",id:i.relearnAfterMovements,label:"Relearn After Movements",unit:"count"},{cls:"relearn-hours",key:"relearn_after_hours",id:i.relearnAfterHours,label:"Relearn After Hours",unit:"h"},{cls:"learn-min-samples",key:"learned_factor_min_samples",id:i.learnedFactorMinSamples,label:"Learned Factor Min Samples",unit:"count"},{cls:"learn-max-deviation",key:"learned_factor_max_deviation_pct",id:i.learnedFactorMaxDeviationPct,label:"Learned Factor Max Deviation",unit:"%"}],Bo=()=>{let e=`

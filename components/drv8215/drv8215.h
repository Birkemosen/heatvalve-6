...
static const uint8_t REG_CONFIG0      = 0x09;  // RW   - EN_STALL, CLR_FLT
...
// CONFIG4 bit masks (PH/EN mode, I2C bridge control)
static const uint8_t CONFIG4_PMODE   = 0x08;  // bit3 - 1 = PH/EN mode
static const uint8_t CONFIG4_I2C_BC  = 0x04;  // bit2 - 1 = I2C bridge control
static const uint8_t CONFIG4_EN      = 0x02;  // bit1 - I2C_EN_IN1  (1 = drive)
static const uint8_t CONFIG4_PH      = 0x01;  // bit0 - I2C_PH_IN2  (1 = forward)

// CONFIG4 pre-built values
static const uint8_t CONFIG4_COAST   = CONFIG4_PMODE | CONFIG4_I2C_BC;             // 0x0C
static const uint8_t CONFIG4_FORWARD = CONFIG4_PMODE | CONFIG4_I2C_BC | CONFIG4_EN | CONFIG4_PH;  // 0x0F
static const uint8_t CONFIG4_REVERSE = CONFIG4_PMODE | CONFIG4_I2C_BC | CONFIG4_EN;               // 0x0E
static const uint8_t CONFIG4_BRAKE   = CONFIG4_PMODE | CONFIG4_I2C_BC | CONFIG4_PH;               // 0x0D

// CONFIG0 values
static const uint8_t CONFIG0_EN_STALL = 0x20;  // EN_STALL=1
static const uint8_t CONFIG0_CLR_FLT  = 0x60;  // CLR_FLT=1, EN_STALL=1
